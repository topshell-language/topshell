//: a -> Task a
exports.of = value => self.tsh.Task2.simple(resolve => resolve(value));
...
exports.concurrent = structure => new self.tsh.Task2(world => {
    var tasks = [];
...
exports.race = task1 => task2 => new self.tsh.Task2(async world => {
...
exports.sequence = tasks => new self.tsh.Task2(async world => {
    let results = [];
...
//: String -> Task a
exports.throw = error => self.tsh.Task2.simple((resolve, reject) => reject(error));

//: (String -> Task a) -> Task a -> Task a
exports.catch = f => task => task.catch(f);

//: Float -> Task {}
exports.sleep = d => self.tsh.Task2.simple(resolve => setTimeout(_ => resolve({}), d * 1000));

//: Task Float
exports.now = self.tsh.Task2.simple(resolve => resolve(Date.now() * 0.001));

//: Task Float
exports.random = new self.tsh.Task2(world => {
    return Promise.resolve({result: Math.random()});
});

//: a -> Task {}
exports.log = message => new self.tsh.Task2(world => {
    console.dir(message);
